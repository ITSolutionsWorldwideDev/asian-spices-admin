                  ...
                  <tbody className="divide-y text-sm text-gray-700">
                    {orders.map((o) => {
                      ...
                      const isStuck =
                        ...
                        Number(o.rejection_count) >= 3;

                      return (
                        <tr
                          key={o.id}
                          className={`hover:bg-gray-50 transition ${isStuck ? "bg-amber-50/60 hover:bg-amber-50" : ""}`}
                        >
                          ...
                          <td className="p-4">
                            <span
                              className={`text-xs font-semibold ${o.payment_status === "paid" ? "text-green-600" : "text-gray-400"}`}
                            >
                              {o.payment_status}
                              {/* // .toUpperCase() */}
                            </span>
                          ...
                          <td className="p-4 text-center">
                            <span
                              className={`font-semibold px-2 py-0.5 rounded ${Number(o.rejection_count) > 0 ? "bg-red-50 text-red-600 font-bold" : "text-gray-400"}`}
                            >
                              {o.rejection_count}
                            </span>
                          </td>
